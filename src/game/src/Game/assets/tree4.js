...
export const TREE_PALETTES = [
    { shadow: 0x1e3a8a, mid: 0x1e40af, light: 0x3b82f6, rim: 0xbfdbfe },
    { shadow: 0x172554, mid: 0x1d4ed8, light: 0x2563eb, rim: 0x93c5fd },
    { shadow: 0x0c4a6e, mid: 0x0369a1, light: 0x38bdf8, rim: 0xe0f2fe },
    { shadow: 0x312e81, mid: 0x4338ca, light: 0x818cf8, rim: 0xeef2ff },
];
...
function createFallingLeavesSystem(parent, foliageTexture, maxLeaves = 260) {
    ...
    const leafColors = [0x3b82f6, 0x60a5fa, 0x93c5fd, 0x2563eb, 0x1d4ed8, 0xbfdbfe];
